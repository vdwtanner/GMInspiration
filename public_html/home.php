...
<div id="container" class="cf">
	...
	<ul id="quick_search" class="quick_search">
		...
		&nbsp<li id="races"><a href="search_results.php?keywords=race&usort=relevance&csort=relevance&searchSubmit=Search">races</a></li>
		&nbsp<li id="spells"><a href="search_results.php?keywords=spell&usort=relevance&csort=relevance&searchSubmit=Search">spells</a></li>
		&nbsp<li id="weapons"><a href="search_results.php?keywords=weapon&usort=relevance&csort=relevance&searchSubmit=Search">weapons</a></li>
	</ul>
	<?php
